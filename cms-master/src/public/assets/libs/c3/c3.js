                ...
                config.interaction_enabled
                    ? function () {
                        ...
                        $$.svg
                            ...
                            .style("cursor", isMouseCloseToDataPoint ? "pointer" : null); // if tooltip not grouped, we want to display only data from closest data point

                        var showSingleDataPoint =
                            !config.tooltip_grouped ||
                            $$.hasType("stanford", targetsToShow); // find data to highlight
