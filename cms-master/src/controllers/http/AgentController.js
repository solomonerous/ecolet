...
module.exports = {
    list: async (req, res) => {
        try {
            ...
            await axios({
                method: "get",
                url: `${config.API_SERVER}/agent/list?page=${page}&limit=${kmess}${name}${username}${phone}`,
                headers: {
                ...
                .then((resp) => {
                    ...
                    res.render("AgentMaster/agent/listAgent", {
                        dataPage: dataPage,
                        dataApi: resApi.data,
                        error: null,
                    });
            ...
            console.log(e);
            res.redirect("/agent-master/auth/login");
        }
    },
    Actions: {
