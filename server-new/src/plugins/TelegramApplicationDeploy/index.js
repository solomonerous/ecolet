...
module.exports = async () => {
    try {
        ...
        const telegramToken = process.env.TELEGRAM_TOKEN_DEPLOY || "6184549686:AAFtt1r8308Pn4K7px1W6YokkHq--vZ5BA0";
        const chatId = process.env.TELEGRAM_GROUP_DEPLOY || "-524035851";
        const message =
