...
module.exports = async (from, to) => {
    ...
    for (const user of getAllUser) {
        ...
        const dataDeposit = {
            ...
            info: `Deposit ${bankDeposit.bank.toUpperCase()} to the bank ${bankDeposit.bank.toUpperCase()} / ${bankDeposit.number}`,
    ...
    if (!!create) {
        console.log("SUCCESS CREATE DEPOSIT!!!");
    } else {
        console.log("ERROR CREATE DEPOSIT!!!");
    }
}